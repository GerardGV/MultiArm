    ...
    while True:
        ...
        if serverData:
            ...
            if instruction == "MOVE":
                ...
                file_path = "imgFaces/VC part/img08_V2_1_face_Pol_sense_sostre.jpeg"  # NOMBRE IMAGEN 1
                destination_blob_name = "image1.jpeg"   # NOMBRE QUE LA IMAGEN QUE TENDRÁ EN EL BUCKET

                # PARÁMETROS PARA LA SEGUNDA IMÁGEN
                file_path2 = "imgFaces/VC part/img08_V2_2_face_Pol_sense_sostre.jpeg"  # NOMBRE IMAGEN 2
