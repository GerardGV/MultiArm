...
<img src="../imgREADMEs/imgREADME_SM/camera_clicked.png" alt= "Camera clicked, 3d dotmap visualized" style="height:200px; width: auto; " />
<br/><br/>
4. **Dibuixar un traç**. A continuació, mitjançant el ratolí es poden dibuixar diferents traçades.  
<img src="../imgREADMEs/imgREADME_SM/drawing.png" alt= "App: Drawing example"> &nbsp;&nbsp;&nbsp;&nbsp; <img src="../imgREADMEs/imgREADME_SM/drawingDone.png" alt= "App: Drawing Done" style="height:202px;" > <br/><br/>
5. **Eliminar l'últim traç**. En cas d'equivocació, es permet esborrar l'últim traç dibuixat utilitzant el botó "Eliminar últim":
<br/> <img src="../imgREADMEs/imgREADME_SM/eliminarUltim.png" alt= "Eliminar Ultim button"/>  
A continuació mostrarem diverses traçades per tal de veure què passa en clicar el botó. <br/>
<img src="../imgREADMEs/imgREADME_SM/multipleDrawingMistake.png" alt= "Multiple Drawing Mistake"/> &nbsp;&nbsp;&nbsp;&nbsp; <img src="../imgREADMEs/imgREADME_SM/drawingEliminarUltim.png" alt= "Eliminar l'últim traç fet." style="height:113px;">  
...
<br/> <img src="../imgREADMEs/imgREADME_SM/enviar_button.png" alt= "Botó enviar">  <br/>
...
<br/><img src="../imgREADMEs/imgREADME_SM/drawingSent.png" alt= "Drawing when button send is clicked."/>  
...
<img src="../imgREADMEs/imgREADME_SM/preReset.png" alt= "Example Before clicking Reset button" style="height:100px;"/> &nbsp;&nbsp;&nbsp;&nbsp; <img src="../imgREADMEs/imgREADME_SM/postReset.png" alt= "Example after clicking the reset button." style="height:100px;" >
<br/><br/>
...
<br/><img src="../imgREADMEs/imgREADME_SM/imageButtons.png" alt= "Image buttons."/>
<br/>
<ul>
...
<br/> <img src="../imgREADMEs/imgREADME_SM/eliminarUltim.png" alt= "Eliminar Ultim button"/> <br/>
A continuación mostraremos varias trazadas para ver qué ocurre al pulsar el botón. <br/>
<img src="../imgREADMEs/imgREADME_SM/multipleDrawingMistake.png" alt= "Multiple Drawing Mistake"/>      <img src="../imgREADMEs/imgREADME_SM/drawingEliminarUltim.png" alt= "Eliminar l'últim traç fet." style="height:113px;"> <br/>
...
<img src="../imgREADMEs/imgREADME_SM/multipleDrawingMistake.png" alt= "Multiple Drawing Mistake"/>      <img src="../imgREADMEs/imgREADME_SM/drawingEliminarUltim.png" alt= "Eliminar l'últim traç fet." style="height:113px;"><br/><br/>
